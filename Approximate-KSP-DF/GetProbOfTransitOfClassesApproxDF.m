function [probOfStateInNonBlocking,probOfStateInFB,probOfStateInRB]= GetProbOfTransitOfClassesApproxDF(bandwidthPerClass,numberOfSlots,oneDsystemStates,numOfNonFBstates,numOfFBstates,numOfRBstates,avgOccupiedSlots)
    ...
    for stateNo=2:numberOfStates-1
        ...
        for c=1:classes 
            if(E>=bandwidthPerClass(c)) 
                ...
                if(numOfFBstates(stateNo,c)==0 || (numOfFBstates(stateNo,c)/totalStates < 0.7))
